module github.com/celestiaclient

go 1.21.5

require github.com/celestiaorg/celestia-openrpc v0.5.0
...
replace github.com/celestiaorg/celestia-openrpc => ../../../celestiaorg/celestia-openrpc
